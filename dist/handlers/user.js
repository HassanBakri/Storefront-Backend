...
var auth = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.authenticate(_req.body.username, _req.body.password)];
            case 1:
                User = _a.sent();
                token = jsonwebtoken_1["default"].sign({ User: User }, hassanconfig_1["default"].JWTSECRIT);
                res.json(token);
                return [2 /*return*/];
        }
    });
...
var create = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                newUser = _a.sent();
                token = jsonwebtoken_1["default"].sign({ User: newUser }, hassanconfig_1["default"].JWTSECRIT);
                res.json(token);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
